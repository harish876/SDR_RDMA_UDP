...
def main():
    ...
    plot_value_vs_size(
        sndr_tp_series,
        sndr_tp_size_labels,
        title="UDP SR - Sender Throughput vs Message Size",
        ylabel="Sender Throughput (Mbps)",
        filename="sr_sndr_throughput_vs_size.png",
    )
    ...
    plot_value_vs_size(
        rcvr_tp_series,
        rcvr_tp_size_labels,
        title="UDP SR - Receiver Throughput vs Message Size",
        ylabel="Receiver Throughput (Mbps)",
        filename="sr_rcvr_throughput_vs_size.png",
    )
    ...
    plot_value_vs_size(
        sndr_tt_series,
        sndr_tt_size_labels,
        title="UDP SR - Sender Transfer Time vs Message Size",
        ylabel="Sender Transfer Time (ms)",
        filename="sr_sndr_transfer_time_vs_size.png",
    )
    ...
    plot_value_vs_size(
        rcvr_tt_series,
        rcvr_tt_size_labels,
        title="UDP SR - Receiver Transfer Time vs Message Size",
        ylabel="Receiver Transfer Time (ms)",
        filename="sr_rcvr_transfer_time_vs_size.png",
    )
