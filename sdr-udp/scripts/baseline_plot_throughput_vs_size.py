...
LOSS_CSV = os.path.join(DATA_DIR, "baseline_Data.csv")
...
def main():
    ...
    plot_value_vs_size(
        sndr_tp_series,
        sndr_tp_size_labels,
        title="UDP Baseline - Sender Throughput vs Message Size",
        ylabel="Sender Throughput (Mbps)",
        filename="baseline_sndr_throughput_vs_size.png",
    )
    ...
    plot_value_vs_size(
        rcvr_tp_series,
        rcvr_tp_size_labels,
        title="UDP Baseline - Receiver Throughput vs Message Size",
        ylabel="Receiver Throughput (Mbps)",
        filename="baseline_rcvr_throughput_vs_size.png",
    )
    ...
    plot_value_vs_size(
        sndr_tt_series,
        sndr_tt_size_labels,
        title="UDP Baseline - Sender Transfer Time vs Message Size",
        ylabel="Sender Transfer Time (ms)",
        filename="baseline_sndr_transfer_time_vs_size.png",
    )
    ...
    plot_value_vs_size(
        rcvr_tt_series,
        rcvr_tt_size_labels,
        title="UDP Baseline - Receiver Transfer Time vs Message Size",
        ylabel="Receiver Transfer Time (ms)",
        filename="baseline_rcvr_transfer_time_vs_size.png",
    )
